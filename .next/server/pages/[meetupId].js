...
async function getStaticPaths() {
  const client = await external_mongodb_.MongoClient.connect('mongodb+srv://kurtiakm:gEXVYAgmvkxrerOS@cluster0.hoy6g.mongodb.net/myFirstDatabase?retryWrites=true&w=majority');
  const db = client.db();
